  ...
  async function handleAuth(e: React.FormEvent) {
    ...
    try {
      if (isLogin) {
        ...
        if (error) throw error
        // If email confirmation is enabled, user gets back but no session
        ...
        <div className="w-full max-w-md">
          <div className="bg-white rounded-2xl shadow-xl p-8 text-center">
            ...
            <p className="text-gray-600 mb-6">
              We've sent a confirmation link to your email. Click the link to activate your account and start using Forapplying.
            </p>
